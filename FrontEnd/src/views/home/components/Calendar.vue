<template>
  <div class="container">
    <div class="goo-cal">
      ...
      <button @click="handleLogClick">log찍기</button>
      <button v-if="!isAuthorized" @click="handleAuthClick">Authorize</button>
      <button v-if="isAuthorized" @click="handleSignoutClick">Sign Out</button>
      <button @click="handleInsertClick">Insert Event</button>
